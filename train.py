...
# TODO: This is very crude, should used cross-validation
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        cnn = TextMPCNN(
            ...
            p_pool_type=FLAGS.p_pool_type.split(','),
        ...
        def train_step(s1, s2, score):
            ...
            _, step, summaries, loss, pearson = sess.run([train_op, global_step, train_summary_op,
                                                          cnn.loss, cnn.pearson], feed_dict)
